...
export function handleTransfer(event: Transfer): void {
  let GoldenHopperVeFlySourceAddress = Address.fromHexString("0x9156289a580ef50956607a107c15399ea9656d73");
  let MarketAddress = Address.fromHexString("0xdace6fb2b7da8e09eb2d092e947a85a4874318f5");
...
export function fulfillListing(event: FulfillListingEv): void {
  let listing = Listing.load(event.params.listingId.toString());
